const int trigger1 = 1; //Trigger pin of 1st Sensor
const int echo1 = 2; //Echo pin of 1st Sensor
const int trigger2 = 3; //Trigger pin of 2nd Sensor
const int echo2 = 4;//Echo pin of 2nd Sensor
